...
public:
	...
	/**
	 * transformObservations Transforms the measurement of the vehicle's coordinate system to the
	 *	 map's coordinate system in respect to a given particle
	 * @param observations Vector of measured landmarks
	 * @param p One candidate for the vehicle's true position
	 * @return A vector of transformed measurements
	 */
	std::vector<LandmarkObs> transformObservations(const std::vector<LandmarkObs> observations, const Particle p) const;
